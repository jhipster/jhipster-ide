...
interface IssueCodes {
	...
	String INVALID_IDENTIFIER_PARAM_MSG = 'Invalid application parameter - invalid identifier!'
	String INVALID_PACKAGE_PARAM_MSG = 'Invalid application parameter - invalid package name!'
