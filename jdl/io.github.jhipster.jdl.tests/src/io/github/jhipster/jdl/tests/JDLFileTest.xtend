...
class JDLFileTest {
	...
	val expectedIssues = #[
		...
		"ex26.jdl" -> 'Found groupable relationship "OneToOne"',
		"wrong_displayfield_in_source.jdl" -> 'Found groupable relationship "ManyToMany"',
		"no_injected_field.jdl" -> 'Found groupable relationship "OneToMany"',
		"big_sample.jdl" -> 'Found groupable relationship "OneToOne"',
		"bug-tracker.jh" -> 'Found groupable relationship "ManyToMany"',
		"intant_type.jdl" -> 'Found groupable relationship "OneToMany"',
		"microservice-ecommerce-store-4-apps.jdl" -> 'Found groupable relationship "OneToOne"',
		"wrong_displayfield_in_target.jdl" -> 'Found groupable relationship "OneToMany"',
		"microservice-ecommerce-store.jdl" -> 'Found groupable relationship "ManyToOne"',
		"no_injected_field.jdl" -> 'Found groupable relationship "OneToOne"',
		"big_sample.jdl" -> 'Found groupable relationship "OneToMany"',
		"realistic_sample.jdl" -> 'Found groupable relationship "ManyToOne"',
		"valid_jdl.jdl" -> 'Found groupable relationship "OneToOne"',
		"ex09.jdl" -> 'Found groupable relationship "OneToMany"',
		"ex29.jdl" -> 'Found groupable relationship "ManyToOne"',
		"ex25.jdl" -> 'Found groupable relationship "OneToOne"',
		"microservice-ecommerce-store-4-apps.jdl" -> 'Found groupable relationship "OneToMany"',
		"wrong_displayfield_in_source.jdl" -> 'Found groupable relationship "ManyToOne"',
		"wrong_displayfield_in_target.jdl" -> 'Found groupable relationship "OneToOne"',
		"intant_type.jdl" -> 'Found groupable relationship "OneToOne"',
		"user_entity_to_relationship.jdl" -> 'Found groupable relationship "ManyToOne"',
		"ex30.jdl" -> 'Found groupable relationship "ManyToMany"',
		"bug-tracker.jh" -> 'Found groupable relationship "ManyToOne"',
		"wrong_required_relationships_jdl.jdl" -> 'Found groupable relationship "ManyToOne"',
		"complex_jdl.jdl" -> 'Found groupable relationship "OneToOne"',
		"ex27.jdl" -> 'Found groupable relationship "OneToMany"',
		"duration_type.jdl" -> 'Found groupable relationship "OneToOne"',
		"microservice-ecommerce-store-k8s.jdl" -> 'Found groupable relationship "OneToOne"',
		"Oracle-Human-Resources-sample.jdl" -> 'Found groupable relationship "OneToOne"',
		"simple.jdl" -> 'Found groupable relationship "OneToMany"',
		"simple-online-shop.jh" -> 'Found groupable relationship "ManyToOne"',
		"different_relationship_types.jdl" -> 'Found groupable relationship "ManyToOne"',
		"different_relationship_types.jdl" -> 'Found groupable relationship "ManyToMany"',
		"microservice-ecommerce-store-k8s.jdl" -> 'Found groupable relationship "OneToMany"',
		"Oracle-Human-Resources-sample.jdl" -> 'Found groupable relationship "OneToMany"',
		"complex_jdl.jdl" -> 'Found groupable relationship "OneToMany"',
		"ex10.jdl" -> 'Found groupable relationship "ManyToMany"',
		"simple-online-shop.jh" -> 'Found groupable relationship "ManyToMany"',
		"duration_type.jdl" -> 'Found groupable relationship "OneToMany"',
		"21-points.jh" -> 'Found groupable relationship "ManyToOne"',
		"online-shop.jh" -> 'Found groupable relationship "OneToMany"',
		"multiple_jdl_comments.jdl" -> 'Found groupable relationship "OneToOne"',
		"wrong_required_relationships_jdl.jdl" -> 'Found groupable relationship "ManyToMany"',
		"ex28.jdl" -> 'Found groupable relationship "OneToMany"',
		"relationship_jpa_derived_identifier.jdl" -> 'Found groupable relationship "OneToOne"',
		"blog.jh" -> 'Found groupable relationship "ManyToOne"',
		"no_injected_field.jdl" -> 'Found groupable relationship "ManyToMany"',
		"microservice-ecommerce-store-4-apps.jdl" -> 'Found groupable relationship "ManyToOne"',
		"wrong_displayfield_in_source.jdl" -> 'Found groupable relationship "OneToMany"',
		"microservice-ecommerce-store.jdl" -> 'Found groupable relationship "OneToOne"',
		"ungrouped_relationships.jdl" -> 'Found groupable relationship "OneToMany"',
		"microservices-blog-store.jh" -> 'Found groupable relationship "ManyToMany"',
		"wrong_displayfield_in_target.jdl" -> 'Found groupable relationship "ManyToMany"',
		"realistic_sample.jdl" -> 'Found groupable relationship "OneToMany"',
		"intant_type.jdl" -> 'Found groupable relationship "ManyToMany"',
		"two_microservices.jdl" -> 'Found groupable relationship "OneToMany"',
		"big_sample.jdl" -> 'Found groupable relationship "ManyToOne"',
		"ex21.jdl" -> 'Found groupable relationship "OneToMany"',
		"wrong_displayfield_in_source.jdl" -> 'Found groupable relationship "OneToOne"',
		"wrong_displayfield_in_target.jdl" -> 'Found groupable relationship "ManyToOne"',
		"ex07.jdl" -> 'Found groupable relationship "ManyToOne"',
		"microservice-ecommerce-store.jdl" -> 'Found groupable relationship "OneToMany"',
		"big_sample.jdl" -> 'Found groupable relationship "ManyToMany"',
		"user_entity_to_relationship.jdl" -> 'Found groupable relationship "OneToOne"',
		"duplicate_relationships.jdl" -> 'Found groupable relationship "OneToMany"',
		"ex11.jdl" -> 'Found groupable relationship "OneToOne"',
		"intant_type.jdl" -> 'Found groupable relationship "ManyToOne"',
		"ex08.jdl" -> 'Found groupable relationship "ManyToOne"',
		"blog.jh" -> 'Found groupable relationship "ManyToMany"',
		"microservices-blog-store.jh" -> 'Found groupable relationship "ManyToOne"',
		"no_comma_support.jdl" -> 'Found groupable relationship "OneToOne"',
		"realistic_sample.jdl" -> 'Found groupable relationship "OneToOne"',
		"different_relationship_types.jdl" -> 'Found groupable relationship "OneToOne"',
		"ex10.jdl" -> 'Found groupable relationship "OneToOne"',
		"unexistent_entities_for_relationship.jdl" -> 'Found groupable relationship "OneToOne"',
		"wrong_required_relationships_jdl.jdl" -> 'Found groupable relationship "OneToOne"',
		"online-shop.jh" -> 'Found groupable relationship "ManyToOne"',
		"microservice-ecommerce-store-k8s.jdl" -> 'Found groupable relationship "ManyToOne"',
		"Oracle-Human-Resources-sample.jdl" -> 'Found groupable relationship "ManyToOne"',
		"complex_jdl.jdl" -> 'Found groupable relationship "ManyToOne"',
		"duration_type.jdl" -> 'Found groupable relationship "ManyToOne"',
		"user_entity_from_relationship.jdl" -> 'Found groupable relationship "OneToMany"',
		"wrong_relationships_jdl.jdl" -> 'Found groupable relationship "OneToOne"',
		"online-shop.jh" -> 'Found groupable relationship "ManyToMany"',
		"duration_type.jdl" -> 'Found groupable relationship "ManyToMany"',
		"complex_jdl.jdl" -> 'Found groupable relationship "ManyToMany"',
		"simple-online-shop.jh" -> 'Found groupable relationship "OneToMany"',
		"different_relationship_types.jdl" -> 'Found groupable relationship "OneToMany"',
		"Oracle-Human-Resources-sample.jdl" -> 'Found groupable relationship "ManyToMany"',
		"21-points.jh" -> 'Found groupable relationship "OneToOne"',
		"cassandra_with_relationships.jdl" -> 'Found groupable relationship "OneToMany"',
		"wrong_required_relationships_jdl.jdl" -> 'Found groupable relationship "OneToMany"',
		"required_relationships.jdl" -> 'Found groupable relationship "OneToOne"',
		"" -> "" // empty
	]
