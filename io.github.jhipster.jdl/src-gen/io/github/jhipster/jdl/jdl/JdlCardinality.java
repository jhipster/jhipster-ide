 ...
 * <!-- end-user-doc -->
 * @see io.github.jhipster.jdl.jdl.JdlPackage#getJdlCardinality()
 * @model
 * @generated
 */
public enum JdlCardinality implements Enumerator
{
  /**
   ...
   * @generated
   */
  private static final JdlCardinality[] VALUES_ARRAY =
    new JdlCardinality[]
    {
      ONE_TO_MANY,
      MANY_TO_ONE,
   ...
   * @generated
   */
  public static final List<JdlCardinality> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
   ...
   * @generated
   */
  public static JdlCardinality get(String literal)
  {
    for (int i = 0; i < VALUES_ARRAY.length; ++i)
    {
      JdlCardinality result = VALUES_ARRAY[i];
   ...
   * @generated
   */
  public static JdlCardinality getByName(String name)
  {
    for (int i = 0; i < VALUES_ARRAY.length; ++i)
    {
      JdlCardinality result = VALUES_ARRAY[i];
   ...
   * @generated
   */
  public static JdlCardinality get(int value)
  {
    switch (value)
    {
   ...
   * @generated
   */
  private JdlCardinality(int value, String name, String literal)
  {
    this.value = value;
    this.name = name;
