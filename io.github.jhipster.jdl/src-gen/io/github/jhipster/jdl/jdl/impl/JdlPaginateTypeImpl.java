 ...
 * </p>
 * <ul>
 *   <li>{@link io.github.jhipster.jdl.jdl.impl.JdlPaginateTypeImpl#isPagination <em>Pagination</em>}</li>
 *   <li>{@link io.github.jhipster.jdl.jdl.impl.JdlPaginateTypeImpl#isInfiniteScroll <em>Infinite Scroll</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JdlPaginateTypeImpl extends MinimalEObjectImpl.Container implements JdlPaginateType
{
  /**
  ...
  {
    return JdlPackage.Literals.JDL_PAGINATE_TYPE;
  }
  ...
  public void setPagination(boolean newPagination)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, JdlPackage.JDL_PAGINATE_TYPE__PAGINATION, oldPagination, pagination));
  }
  ...
  public void setInfiniteScroll(boolean newInfiniteScroll)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, JdlPackage.JDL_PAGINATE_TYPE__INFINITE_SCROLL, oldInfiniteScroll, infiniteScroll));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case JdlPackage.JDL_PAGINATE_TYPE__PAGINATION:
        return isPagination();
      case JdlPackage.JDL_PAGINATE_TYPE__INFINITE_SCROLL:
