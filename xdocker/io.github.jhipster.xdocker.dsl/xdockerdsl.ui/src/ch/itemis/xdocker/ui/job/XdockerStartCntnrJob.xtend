 ...
 */
class XdockerStartCntnrJob extends AbstractXdockerJob {

	static val JOB_NAME = 'Docker Start Container Job'
	static val ERR_STOP_CONTAINER = 'Error starting container from docker'
	static val TASK_STOP_CONTAINER = 'Starting container from docker...\n'
